...
Suppose we have a rainbow path $ P = (x_0, e_0, \dots, x_{l-1}, e_{l-1}, x_{l}) $ of length $ l $.
...
We may assume that there always exists a rainbow path with $ l \geq 2 $, since every graph 
