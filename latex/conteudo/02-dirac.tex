...
\cite{dirac1952theorem} states that if a simple graph $G = (V, E)$ with $n$ vertices satisfies the condition $\deg_G(v) \geq \frac{n}{2}$ for all $v \in V$, 
...
\begin{proof}
    ...
    $G'$ is not a complete graph, because otherwise it would be hamiltonian. Consider an edge $e = \{u, v\} \not\in E'$.
    The graph $(V, E' + e)$ must contain a hamiltonian cycle $C = (v_1, e_1, v_2, e_2, \ldots, v_n, e_{n}, v_1)$.
\end{proof}
